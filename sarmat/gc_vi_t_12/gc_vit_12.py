...
Original file is located at
    https://colab.research.google.com/drive/1Vh25PSPE0s4wFb6_LYR3PysJaw3n9jzS

gcvit implementation

pkts - keras standalone
  keras - ops
  keras - layers
tensorflow
...
keras - cv
keras - cv avoided DropPath implemented
"""

import numpy as np  # version[2.2.6]
import keras # version[3.10.0]
from keras import layers
from keras import ops
import tensorflow as tf # version[1.17.1]
import matplotlib.pyplot as plt

from sklearn.metrics import classification_report

"""Aim - implement Global context vision transformer
version 12
...
datasets
  1. cifar100
  2. isar(Simulated)
  3. isar(Simulated + Real)

Future_works
research base - (inception,resnet) + gcvit12
...
code_structure
    class DropPath
    class SqueezeAndExicution
    class ReduceSize
    class MLP
    class PatchEmbed
    class FeatureExtraction
    class GlobalQueryGenerator
